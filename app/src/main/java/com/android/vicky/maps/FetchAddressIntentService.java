...
public class FetchAddressIntentService extends IntentService {
     ...
     * Note: We define a {@link android.os.ResultReceiver} in * SecondScreen to process content
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String  location1 = sharedPreferences.getString("lat", "07:00") ;
        String  location2 = sharedPreferences.getString("lon", "07:00") ;
        double latitude = Double.parseDouble(location1);
        double longitude = Double.parseDouble(location2);
