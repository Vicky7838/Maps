...
public class FouthScreen extends AppCompatActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String  location1 = sharedPreferences.getString("locc", "08:00") ;
        String  location2 = sharedPreferences.getString("locd", "08:00") ;
        etDestination.setText(location2);
        etOrigin.setText(location1);
